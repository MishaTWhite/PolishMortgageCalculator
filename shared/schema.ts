...
export const propertyPrices = pgTable("property_prices", {
  ...
  averagePricePerSqm: decimal("average_price_per_sqm", { precision: 12, scale: 2 }).notNull(),
  ...
  oneRoomAvgPrice: decimal("one_room_avg_price", { precision: 12, scale: 2 }).default("0"),
  twoRoomCount: integer("two_room_count").default(0),
  twoRoomReportedCount: integer("two_room_reported_count").default(0),
  twoRoomAvgPrice: decimal("two_room_avg_price", { precision: 12, scale: 2 }).default("0"),
  threeRoomCount: integer("three_room_count").default(0),
  threeRoomReportedCount: integer("three_room_reported_count").default(0),
  threeRoomAvgPrice: decimal("three_room_avg_price", { precision: 12, scale: 2 }).default("0"),
  ...
  fourPlusRoomAvgPrice: decimal("four_plus_room_avg_price", { precision: 12, scale: 2 }).default("0"),
